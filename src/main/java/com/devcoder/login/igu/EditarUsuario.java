...
public class EditarUsuario extends javax.swing.JPanel {
    ...
    public EditarUsuario(Controladora control, int idUsuario) {
    ...
    private void initComponents() {
        ...
        titulo.setText("Modificación de usuarios");
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        // Confirmar si desea editar dicho registro
        if(JOptionPane.showConfirmDialog(this, "¿Desea realmente editar este usuario?", "Confirmación", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
            
            control.editarUsuario(id, nombre, apellido, correo, contrasenia1, rol);
            JOptionPane.showMessageDialog(this, "Usuario editado correctamente.", "Edición exitosa", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void llenarCampos(int idUsuario) {
        ...
        this.usuario = control.traerUsuario(idUsuario);
        
        txtNombre.setText(usuario.getNombre());
        txtApellido.setText(usuario.getApellido());
        txtCorreo.setText(usuario.getCorreoElectronico());
        txtContrasenia1.setText(usuario.getContrasenia()); // Mala práctica
        txtContrasenia2.setText(usuario.getContrasenia()); // Mala práctica
        if(cmbRoles.getItemCount() == this.cantRoles){
    ...
    private boolean validar(){
        ...
        if(txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txtCorreo.getText().isEmpty() || txtContrasenia1.getPassword().length == 0 || txtContrasenia2.getPassword().length == 0){
            JOptionPane.showMessageDialog(this, "Debe completar todos los campos para editar", "Error al editar", JOptionPane.ERROR_MESSAGE);
            return true;
            
        }else if(String.valueOf(cmbRoles.getSelectedItem()).equals("Seleccione un rol")){
            
            JOptionPane.showMessageDialog(this, "Debe seleccionar un rol de la lista desplegable", "Error al editar", JOptionPane.ERROR_MESSAGE);
            return true;
        }
